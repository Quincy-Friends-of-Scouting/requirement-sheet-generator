...
def image_file():
    return "TrafficSafety.webp"

def file_name():
    return "traffic-safety.pdf"

def sign_name():
    return name() + " Merit Badge"

def sign_file_name():
    return "traffic-safety-sign.pdf"
