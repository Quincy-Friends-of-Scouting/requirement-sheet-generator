def name():
    return "American Labor"

def sign_name():
    return name() + ' Merit Badge'

def image_file():
    return "AmericanLabor.webp"

def file_name():
    return "american-labor.pdf"

def sign_file_name():
    return "american-labor-sign.pdf"
...
def requirements():
    return [
        ...
        ["2. With your counselor's and parent or guardian's approval and permission, visit the office or attend a meeting of a local union, a central labor council, or an employee organization, or contact one of these organizations via the internet. Then do EACH of the following:", [
